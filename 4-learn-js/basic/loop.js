...
// console.log(separateOddEven([1,2,3,4,5,6,7]));
...
// console.log(arraySlice(points, 3, 3));
...
// console.log(rect(4, 4, 0));
// console.log(rect(4, 4, "A"));
...
// const triangleReverse = function (h, char = "*") {
//   let result = "";
//   for (let x = h; x >= 1; x--) {
//     for (let i = 1; i <= x; i++) {
//       result += `${char} `;
...
//   //   resultBySubject === "failed" && (overAllResult = "failed");
...
// 2. studentMark မှဘာသာရပ်တစ်ခုစီ အောင်မြင်၊ ကျရှံးတွက်ပေးပါ
